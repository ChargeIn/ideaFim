...
The following `:set` commands can appear in `~/.ideafimrc` or be set manually in the command mode:

    'clipboard'      'cb'       clipboard options
                                Standard clipboard options plus 
                                
                                `ideaput`  (default on)   - IdeaFim ONLY
    ...
    `keymodel`       `km`       String (default "continueselect,stopselect")
                 ...
                 can do. These values can be used:
                   ...
                   stopselect         Using a NOT-shifted special[1] key stops     - IdeaFim ONLY
                                      select mode and removes selection.
                   stopvisual         Using a NOT-shifted special[1] key stops     - IdeaFim ONLY
                                      visual mode and removes selection.
                   continueselect     Using a shifted arrow key doesn't       - IdeaFim ONLY
                                      start selection, but in select mode
                                      acts like startsel is enabled
                   continuevisual     Using a shifted arrow key doesn't       - IdeaFim ONLY
    ...
    `selectmode`     `slm`   String (default "")
                 ...
                 Possible values:
                   ...
                   ideaselection   when IDE sets a selection      - IdeaFim ONLY
    ...
    'fiminfo'        'vi'        information to remember after restart
    'visualbell'     'vb'        use visual bell instead of beeping
    'wrapscan'       'ws'        searches wrap around the end of file
    
    
    
    IdeaFim only commands:
    ...
    `ideastatusicon`  `ideastatusicon` String(default "enabled")
                 ...
                 Define the behavior of IdeaFim icon in the status bar.
    ...
    `lookupkeys`    `lookupkeys`   List of strings
                  ...
                  For example, <Tab> and <Enter> are used by the IDE to finish the lookup,
                        but <C-W> should be passed to IdeaFim.
                  Default value: 
                        "<Tab>", "<Down>", "<Up>", "<Enter>", "<Left>", "<Right>",
                        "<C-Down>", "<C-Up>", "<PageUp>", "<PageDown>",
                        "<C-J>", "<C-Q>"
                     
    `ideafimsupport`  `ideafimsupport`  List of strings (default "dialog")
                  
                  Define the list of additional buffers where IdeaFim is enabled.
                  
                  - dialog - enable IdeaFim in dialogs
                  - singleline - enable IdeaFim in single line editors (not suggested)
