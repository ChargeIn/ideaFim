...
import org.jetbrains.plugins.ideafim.propertybased.samples.javaText
import org.jetbrains.plugins.ideafim.propertybased.samples.loremText
 ...
 */
class RandomActionsPropertyTest : FimPropertyTestBase() {
...
private class AvailableActions(private val editor: Editor) : ImperativeCommand {
  override fun performCommand(env: ImperativeCommand.Environment) {
    val currentNode = editor.fim.fimStateMachine.commandBuilder.getCurrentTrie()
    ...
    FimTestCase.typeText(listOf(usedKey), editor, editor.project)
