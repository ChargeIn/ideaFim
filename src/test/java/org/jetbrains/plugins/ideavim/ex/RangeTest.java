 ...
 */
public class RangeTest extends FimTestCase {
  ...
  public void testOffsetWithoutPlusSign() {
    // Not part of the documentation, but it works in Fim - essentially the same as ":.+2d"
    configureByText("1\n<caret>2\n3\n4\n5\n");
    typeText(commandToKeys(".2d"));
    assertState("1\n2\n3\n5\n");
  }
  ...
  @TestWithoutNeofim(reason = SkipNeofimReason.DIFFERENT, description = "idk")
