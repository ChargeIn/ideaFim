...
class RegistersCommandTest : FimTestCase() {
  ...
  fun `test list truncates long registers`() {
    ...
    com.flop.idea.fim.FimPlugin.getRegister().setKeys('a', injector.parser.parseKeys(indent + text))
  ...
  fun `test correctly encodes non printable characters`() {
    ...
    com.flop.idea.fim.FimPlugin.getRegister().setKeys('a', injector.parser.parseKeys("<Tab>Hello<Space>World<CR><Esc>"))
