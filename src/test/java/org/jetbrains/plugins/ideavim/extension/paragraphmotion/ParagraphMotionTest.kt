...
package org.jetbrains.plugins.ideafim.extension.paragraphmotion

import com.flop.idea.fim.command.FimStateMachine
import org.jetbrains.plugins.ideafim.FimTestCase

class ParagraphMotionTest : FimTestCase() {

  override fun setUp() {
    super.setUp()
    enableExtensions("fim-paragraph-motion")
  }
  ...
  fun `test paragraph next without whitespace`() {
    ...
    val after = """I found it in a legendary land
        ...
        |where it was settled on some sodden sand
        |hard by the torrent of a mountain pass.""".trimMargin()
    doTest("}", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun `test paragraph next with whitespace visual`() {
    ...
    val after = """I found it in a legendary land
        ...
        |where it was settled on some sodden sand
        |hard by the torrent of a mountain pass.""".trimMargin().dotToSpace()
    doTest("v}", before, after, FimStateMachine.Mode.VISUAL, FimStateMachine.SubMode.VISUAL_CHARACTER)
  }
  ...
  fun `test paragraph next with whitespace delete`() {
    ...
    val after = """I found it in a legendary land
        ...
        |where it was settled on some sodden sand
        |hard by the torrent of a mountain pass.""".trimMargin().dotToSpace()
    doTest("d}", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
