...
class FimExchangeWithClipboardTest : FimOptionTestCase(OptionConstants.clipboardName) {
  ...
  // |cx|
  @FimOptionTestConfiguration(FimTestOption(OptionConstants.clipboardName, OptionValueType.STRING, "unnamed"))
