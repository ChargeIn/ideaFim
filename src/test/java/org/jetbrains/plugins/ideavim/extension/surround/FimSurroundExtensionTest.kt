...
package org.jetbrains.plugins.ideafim.extension.surround
 ...
 * @author dhleong
 */
class FimSurroundExtensionTest : FimTestCase() {
  ...
  fun testSurroundWordParens() {
    ...
    doTest("yseb", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yse)", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  ...
  fun testSurroundWordArray() {
    ...
    doTest("yser", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yse]", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yse[", before, "int foo = bar[ index ];", FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testSurroundWordAngle() {
    ...
    doTest("ysea", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yse>", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testSurroundQuotes() {
    ...
    doTest("yst;\"", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ys4w\"", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testSurroundFunctionNameDoesNothingIfInputIsEmpty() {
    // The cursor does not move. This is different from Fim
  ...
  fun testRepeatSurround() {
    ...
    doTest(listOf("ysiw)", "l", "."), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testRepeatSurroundDouble() {
    ...
    doTest(listOf("ysiw)", "l", ".", "l", "."), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testRepeatDifferentChanges() {
    ...
    doTest(listOf("ysiw)", "cs\"'", "j", "."), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testRepeatWrapWithTag() {
    ...
    doTest(listOf("ysiwt", "myTag>", "j", "."), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testVisualSurroundWordParens() {
    ...
    doTest("veSb", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    assertMode(FimStateMachine.Mode.COMMAND)
    doTest("veS)", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    assertMode(FimStateMachine.Mode.COMMAND)
    doTest(
      "veS(", before,
      "if ( condition ) {\n" + "}\n", FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE
  ...
  fun testDeleteSurroundingParens() {
    ...
    doTest("dsb", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds(", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds)", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testDeleteSurroundingBlock() {
    ...
    doTest(listOf("dsB"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds}", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds{", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testDeleteSurroundingArray() {
    ...
    doTest("dsr", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds]", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds[", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testDeleteSurroundingAngle() {
    ...
    doTest("dsa", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds>", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("ds<", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testDeleteSurroundingTag() {
    ...
    doTest(listOf("dst"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testDeleteInvalidSurroundingCharacter() {
    ...
    doTest("yibds]", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yibds[", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yibds}", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yibds{", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testRepeatDeleteSurroundQuotes() {
    ...
    doTest(listOf("ds\"."), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testChangeSurroundingParens() {
    ...
    doTest(listOf("csbr"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testChangeSurroundingBlock() {
    ...
    doTest(listOf("csBb"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testChangeSurroundingTagSimple() {
    ...
    doTest(listOf("cstb"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testChangeSurroundingTagAnotherTag() {
    ...
    doTest(listOf("cst<b>"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testRepeatChangeSurroundingParens() {
    ...
    doTest(listOf("csbrE."), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testChangeInvalidSurroundingCharacter() {
    ...
    doTest("yibcs]}", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yibcs[}", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yibcs}]", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
    doTest("yibcs{]", text, text, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testMappingSurroundPlugin() {
    ...
    doTest(":map gw ysiw\"<CR>gw", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun testSurroundPluginWithMacro() {
    ...
    doTest("qqds)qj@q", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun `test change surround with multicaret`() {
    ...
    doTest(listOf("cs(]"), before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
