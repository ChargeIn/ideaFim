...
package org.jetbrains.plugins.ideafim.action.motion.search
...
class SearchAgainPreviousActionTest : FimTestCase() {
  ...
  private fun doTestWithSearch(keys: String, before: String, after: String) {
    doTest(keys, before, after) {
      com.flop.idea.fim.FimPlugin.getSearch().setLastSearchState(it, "all", "", Direction.FORWARDS)
    }
  }
}
