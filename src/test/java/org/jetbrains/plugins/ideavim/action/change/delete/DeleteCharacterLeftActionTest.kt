...
// |X|
class DeleteCharacterLeftActionTest : FimTestCase() {
  ...
  fun `test deleting characters scrolls caret into view`() {
    com.flop.idea.fim.FimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.sidescrolloffName, FimInt(5))
