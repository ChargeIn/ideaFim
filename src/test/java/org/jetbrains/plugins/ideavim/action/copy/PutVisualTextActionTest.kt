 ...
 *   d      b ||  7  |  8  |  9  |
 */
class PutVisualTextActionTest : FimTestCase() {
  ...
  fun `test put visual text`() {
    ...
    com.flop.idea.fim.FimPlugin.getRegister().storeText(editor.fim, before rangeOf "legendary", SelectionType.CHARACTER_WISE, false)
    typeText(injector.parser.parseKeys("ve" + "p"))
  ...
  fun `test put visual text linewise`() {
    ...
    """.trimIndent()
    val editor = configureByText(before)
    com.flop.idea.fim.FimPlugin.getRegister().storeText(editor.fim, before rangeOf "A Discovery\n", SelectionType.LINE_WISE, false)
    typeText(injector.parser.parseKeys("ve" + "p"))
    val after = """
            A Discovery
  ...
  fun `test put visual text blockwise`() {
    ...
    """.trimIndent()
    val editor = configureByText(before)
    com.flop.idea.fim.FimPlugin.getRegister().storeText(editor.fim, editor.rangeOf("|found|", 2), SelectionType.BLOCK_WISE, false)
    typeText(injector.parser.parseKeys("ve" + "p"))
    val after = """
            A Discovery
...
//    FimPlugin.getRegister().storeText(editor.fim, editor.rangeOf("|found|", 2), SelectionType.BLOCK_WISE, false)
    typeText(injector.parser.parseKeys("ve" + "\"*p"))
    val after = """
            A Discovery
  ...
  fun `test put visual text character to line`() {
    ...
    """.trimIndent()
    val editor = configureByText(before)
    com.flop.idea.fim.FimPlugin.getRegister().storeText(editor.fim, before rangeOf "Discovery", SelectionType.CHARACTER_WISE, false)
    typeText(injector.parser.parseKeys("V" + "p"))
    val after = """
            A Discovery
