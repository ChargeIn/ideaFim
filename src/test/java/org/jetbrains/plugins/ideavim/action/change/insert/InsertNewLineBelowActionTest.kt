...
class InsertNewLineBelowActionTest : FimTestCase() {
  ...
  fun `test insert new line below with count`() {
    ...
    val after = """I found it in a legendary land
        ...
        |where it was settled on some sodden sand
        |hard by the torrent of a mountain pass.""".trimMargin()
    doTest("5o", before, after, FimStateMachine.Mode.INSERT, FimStateMachine.SubMode.NONE)
  }
  ...
  fun `test insert new line below with count and escape`() {
    ...
    val after = """I found it in a legendary land
        ...
        |where it was settled on some sodden sand
        |hard by the torrent of a mountain pass.""".trimMargin()
    doTest("5o123<esc>", before, after, FimStateMachine.Mode.COMMAND, FimStateMachine.SubMode.NONE)
  }
  ...
  fun `test insert new line below with folds`() {
    ...
    performTest("o", after, FimStateMachine.Mode.INSERT, FimStateMachine.SubMode.NONE)
  }

  @TestWithoutNeofim(reason = SkipNeofimReason.FOLDING, "Neofim doesn't support arbitrary folds")
