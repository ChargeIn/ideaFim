 ...
 */
class ScrollColumnRightActionTest : FimTestCase() {
  ...
  @FimBehaviorDiffers(description = "Fim has virtual space at the end of line. IdeaFim will scroll up to length of longest line")
  @TestWithoutNeofim(SkipNeofimReason.SCROLL)
  ...
  fun`test scroll last column to right moves cursor 2`() {
    ...
    // Assert we got initial scroll correct
    // Note, this matches Fim - we've scrolled to centre (but only because the line above allows us to scroll without
    // virtual space)
