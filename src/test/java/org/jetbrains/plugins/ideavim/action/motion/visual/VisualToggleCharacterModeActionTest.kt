...
class VisualToggleCharacterModeActionTest : FimTestCase() {
  fun `test fim start after enter visual`() {
    val before = """
            A Discovery
    ...
    assertEquals(startOffset, myFixture.editor.caretModel.primaryCaret.fimSelectionStart)
  }

  fun `test fim start after enter visual with motion`() {
    val before = """
            A Discovery
  ...
  fun `test fim start after enter visual multicaret`() {
    val before = """
            A Discovery
    ...
    assertEquals(startOffset1, myFixture.editor.caretModel.allCarets[0].fimSelectionStart)
    assertEquals(startOffset2, myFixture.editor.caretModel.allCarets[1].fimSelectionStart)
  }

  fun `test fim start after enter visual multicaret with merge`() {
    val before = """
            A Discovery
  ...
  fun `test fim start after enter visual multicaret with merge to left`() {
    val before = """
            A Discovery
  ...
  @FimBehaviorDiffers(description = "Different caret postion")
