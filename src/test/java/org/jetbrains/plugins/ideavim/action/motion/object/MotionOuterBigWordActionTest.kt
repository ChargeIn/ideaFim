...
class MotionOuterBigWordActionTest : FimTestCase() {
  @TestWithoutNeofim(SkipNeofimReason.UNCLEAR, description = "Wrong caret position, but in real neofim works fine")
