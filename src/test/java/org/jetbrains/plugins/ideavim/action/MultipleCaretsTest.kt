...
class MultipleCaretsTest : FimTestCase() {
  // com.flop.idea.fim.action.visual.leftright
...
"""
  ...
  // com.flop.idea.fim.action.visual.updown
...
"""
  ...
  // com.flop.idea.fim.action.visual.object
  ...
  // com.maddyhime.idea.fim.action.visual.text
 ...
 $c   private static void firstMethod(int argument) {
  ...
  // com.flop.idea.fim.action.visual.visual
  ...
  // com.flop.idea.fim.action.change.change
...
"""
  ...
  // com.flop.idea.fim.action.change.delete
...
"""
  ...
  // com.flop.idea.fim.action.change.insert
...
"""
  ...
  @FimBehaviorDiffers(originalFimAfter = "${c}\n${c}\nabcde\n${c}\n${c}\nabcde\n")
  ...
  // com.flop.idea.fim.action.change.shift
...
rtyfg${c}hzxc"""
  ...
  fun testPutTextBeforeCursorOverlapRange() {
    ...
    com.flop.idea.fim.FimPlugin.getRegister().storeText(IjFimEditor(editor), TextRange(16, 19), SelectionType.CHARACTER_WISE, false)
