...
import static com.flop.idea.fim.register.RegisterConstants.*;

/**
 * @author ayzen
 */
public class SpecialRegistersTest extends FimTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    final RegisterGroup registerGroup = FimPlugin.getRegister();
    registerGroup.setKeys('a', FimInjectorKt.getInjector().getParser().stringToKeys(DUMMY_TEXT));
    registerGroup.setKeys(SMALL_DELETION_REGISTER, FimInjectorKt.getInjector().getParser().stringToKeys(DUMMY_TEXT));
    for (char c = '0'; c <= '9'; c++) {
      registerGroup.setKeys(c, FimInjectorKt.getInjector().getParser().stringToKeys(DUMMY_TEXT));
    }
  }

  // VIM-581
  public void testSmallDelete() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("de"), "one <caret>two three\n");
  ...
  public void testSmallDeleteWithPercent() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("d%"), "(one<caret> two) three\n");
  ...
  public void testSmallDeleteTillPrevSentence() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("d("), "One. Two<caret>. Three.\n");
  ...
  public void testSmallDeleteWithMark() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("ma" + "b" + "d`a"), "one two<caret> three\n");
  ...
  public void testSmallDeleteWithSearch() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("d/" + "o" + "<Enter>"), "one <caret>two three\n");
  ...
  public void testSmallDeleteWithBackSearch() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("d?" + "t" + "<Enter>"), "one two<caret> three\n");
  ...
  public void testSmallDeleteWithSearchRepeat() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("/" + "t" + "<Enter>" + "dn"), "<caret>one two three\n");
  ...
  public void testSmallDeleteWithBackSearchRepeat() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("/" + "t" + "<Enter>" + "dN"), "one tw<caret>o three\n");
  ...
  public void testSmallDeleteInRegister() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("\"ade"), "one <caret>two three\n");
  ...
  public void testLineDelete() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("dd"), "one <caret>two three\n");
  ...
  public void testLineDeleteInRegister() {
    typeTextInFile(FimInjectorKt.getInjector().getParser().parseKeys("\"add"), "one <caret>two three\n");
  ...
  public void testNumberedRegistersShifting() {
    ...
    typeText(FimInjectorKt.getInjector().getParser().parseKeys("dd" + "dd"));
    assertEquals("one\n", getRegisterText('2'));
    assertEquals("two\n", getRegisterText('1'));

    typeText(FimInjectorKt.getInjector().getParser().parseKeys("dd" + "dd" + "dd"));
    assertEquals("one\n", getRegisterText('5'));
    assertEquals("four\n", getRegisterText('2'));

    typeText(FimInjectorKt.getInjector().getParser().parseKeys("dd" + "dd" + "dd" + "dd"));
    assertEquals("one\n", getRegisterText('9'));
  }
  ...
  public void testLastInsertedTextRegister() {
    ...
    typeText(FimInjectorKt.getInjector().getParser().parseKeys("i" + "abc" + "<Esc>"));
