...
class UiTests {
  ...
  @Test
  @Video
  fun ideaFimTest() = uiTest("ideaFimTest") {
...
//    assertTrue(editor.isBlockCursor)
  ...
  private fun IdeaFrame.reenableIdeaFim(editor: Editor) {
    println("Run reenableIdeaFim...")
    toggleIdeaFim()
  ...
  private fun IdeaFrame.toggleIdeaFim() {
    this.remoteRobot.invokeActionJs("FimPluginToggle")
  }
