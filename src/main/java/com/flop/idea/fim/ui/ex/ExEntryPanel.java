...
package com.flop.idea.fim.ui.ex;
...
import com.flop.idea.fim.ui.ExPanelBorder;
...
import com.flop.idea.fim.ex.ranges.LineRange;
import com.flop.idea.fim.group.MotionGroup;
import com.flop.idea.fim.helper.SearchHighlightsHelper;
...
public class ExEntryPanel extends JPanel {
  ...
  public void deactivate(boolean refocusOwningEditor, boolean resetCaret) {
    ...
    try {
      ...
      if (isIncSearchEnabled()) {
        ...
        FimPlugin.getSearch().resetIncsearchHighlights();
      }
  ...
  private final @NotNull DocumentListener incSearchDocumentListener = new DocumentAdapter() {
    ...
    protected void textChanged(@NotNull DocumentEvent e) {
      ...
      if (label.getText().equals(":")) {
        ...
        searchRange = command.getLineRange(new IjFimEditor(editor));
      }
      ...
      if (labelText.equals("/") || labelText.equals("?") || searchCommand) {
        ...
        FimPlugin.getEditor().closeEditorSearchSession(editor);
    ...
    private @Nullable Command getIncsearchCommand(@Nullable String commandText) {
      ...
      try {
        final Command exCommand = FimscriptParser.INSTANCE.parseCommand(commandText);
  ...
  private boolean isIncSearchEnabled() {
    return FimPlugin.getOptionService().isSet(OptionScope.GLOBAL.INSTANCE, OptionConstants.incsearchName, OptionConstants.incsearchName);
  }
