...
package com.flop.idea.fim.action.internal
...
class AddInlineInlaysAction : AnAction() {
  ...
  override fun actionPerformed(e: AnActionEvent) {
    ...
    val lineLength = com.flop.idea.fim.helper.EditorHelper.getLineLength(editor, com.flop.idea.fim.helper.EditorHelper.visualLineToLogicalLine(editor, currentVisualLine))
    while (i < lineLength) {
      ...
      val offset = com.flop.idea.fim.helper.EditorHelper.visualPositionToOffset(editor, VisualPosition(currentVisualLine, i))
