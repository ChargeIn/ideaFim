...
import com.flop.idea.fim.ex.ranges.Range
import com.flop.idea.fim.ex.ranges.Range.Companion.createRange
import com.flop.idea.fim.ex.ranges.Ranges
import com.flop.idea.fim.fimscript.model.commands.ActionCommand
import com.flop.idea.fim.fimscript.model.commands.ActionListCommand
import com.flop.idea.fim.fimscript.model.commands.AsciiCommand
import com.flop.idea.fim.fimscript.model.commands.BufferCloseCommand
import com.flop.idea.fim.fimscript.model.commands.BufferCommand
import com.flop.idea.fim.fimscript.model.commands.BufferListCommand
import com.flop.idea.fim.fimscript.model.commands.CallCommand
import com.flop.idea.fim.fimscript.model.commands.CmdClearCommand
import com.flop.idea.fim.fimscript.model.commands.CmdCommand
import com.flop.idea.fim.fimscript.model.commands.CmdFilterCommand
import com.flop.idea.fim.fimscript.model.commands.Command
import com.flop.idea.fim.fimscript.model.commands.CopyTextCommand
import com.flop.idea.fim.fimscript.model.commands.DelCmdCommand
import com.flop.idea.fim.fimscript.model.commands.DeleteLinesCommand
import com.flop.idea.fim.fimscript.model.commands.DeleteMarksCommand
import com.flop.idea.fim.fimscript.model.commands.DelfunctionCommand
import com.flop.idea.fim.fimscript.model.commands.DigraphCommand
import com.flop.idea.fim.fimscript.model.commands.DumpLineCommand
import com.flop.idea.fim.fimscript.model.commands.EchoCommand
import com.flop.idea.fim.fimscript.model.commands.EditFileCommand
import com.flop.idea.fim.fimscript.model.commands.ExecuteCommand
import com.flop.idea.fim.fimscript.model.commands.ExitCommand
import com.flop.idea.fim.fimscript.model.commands.FileCommand
import com.flop.idea.fim.fimscript.model.commands.FindClassCommand
import com.flop.idea.fim.fimscript.model.commands.FindFileCommand
import com.flop.idea.fim.fimscript.model.commands.FindSymbolCommand
import com.flop.idea.fim.fimscript.model.commands.GlobalCommand
import com.flop.idea.fim.fimscript.model.commands.GoToLineCommand
import com.flop.idea.fim.fimscript.model.commands.GotoCharacterCommand
import com.flop.idea.fim.fimscript.model.commands.HelpCommand
import com.flop.idea.fim.fimscript.model.commands.HistoryCommand
import com.flop.idea.fim.fimscript.model.commands.JoinLinesCommand
import com.flop.idea.fim.fimscript.model.commands.JumpsCommand
import com.flop.idea.fim.fimscript.model.commands.LetCommand
import com.flop.idea.fim.fimscript.model.commands.LockVarCommand
import com.flop.idea.fim.fimscript.model.commands.MarkCommand
import com.flop.idea.fim.fimscript.model.commands.MarksCommand
import com.flop.idea.fim.fimscript.model.commands.MoveTextCommand
import com.flop.idea.fim.fimscript.model.commands.NextFileCommand
import com.flop.idea.fim.fimscript.model.commands.NextTabCommand
import com.flop.idea.fim.fimscript.model.commands.NoHLSearchCommand
import com.flop.idea.fim.fimscript.model.commands.NormalCommand
import com.flop.idea.fim.fimscript.model.commands.OnlyCommand
import com.flop.idea.fim.fimscript.model.commands.PackaddCommand
import com.flop.idea.fim.fimscript.model.commands.PlugCommand
import com.flop.idea.fim.fimscript.model.commands.PreviousFileCommand
import com.flop.idea.fim.fimscript.model.commands.PreviousTabCommand
import com.flop.idea.fim.fimscript.model.commands.PrintCommand
import com.flop.idea.fim.fimscript.model.commands.PromptFindCommand
import com.flop.idea.fim.fimscript.model.commands.PromptReplaceCommand
import com.flop.idea.fim.fimscript.model.commands.PutLinesCommand
import com.flop.idea.fim.fimscript.model.commands.QuitCommand
import com.flop.idea.fim.fimscript.model.commands.RedoCommand
import com.flop.idea.fim.fimscript.model.commands.RegistersCommand
import com.flop.idea.fim.fimscript.model.commands.RepeatCommand
import com.flop.idea.fim.fimscript.model.commands.SelectFileCommand
import com.flop.idea.fim.fimscript.model.commands.SelectFirstFileCommand
import com.flop.idea.fim.fimscript.model.commands.SelectLastFileCommand
...
import com.flop.idea.fim.fimscript.model.commands.SetLocalCommand
import com.flop.idea.fim.fimscript.model.commands.ShellCommand
import com.flop.idea.fim.fimscript.model.commands.ShiftLeftCommand
import com.flop.idea.fim.fimscript.model.commands.ShiftRightCommand
import com.flop.idea.fim.fimscript.model.commands.SortCommand
import com.flop.idea.fim.fimscript.model.commands.SourceCommand
...
import com.flop.idea.fim.fimscript.model.commands.TabCloseCommand
import com.flop.idea.fim.fimscript.model.commands.TabMoveCommand
import com.flop.idea.fim.fimscript.model.commands.TabOnlyCommand
import com.flop.idea.fim.fimscript.model.commands.UndoCommand
import com.flop.idea.fim.fimscript.model.commands.UnknownCommand
import com.flop.idea.fim.fimscript.model.commands.UnlockVarCommand
import com.flop.idea.fim.fimscript.model.commands.WriteAllCommand
import com.flop.idea.fim.fimscript.model.commands.WriteCommand
import com.flop.idea.fim.fimscript.model.commands.WriteNextFileCommand
import com.flop.idea.fim.fimscript.model.commands.WritePreviousFileCommand
import com.flop.idea.fim.fimscript.model.commands.WriteQuitCommand
import com.flop.idea.fim.fimscript.model.commands.YankLinesCommand
import com.flop.idea.fim.fimscript.model.commands.mapping.MapClearCommand
import com.flop.idea.fim.fimscript.model.commands.mapping.MapCommand
import com.flop.idea.fim.fimscript.model.commands.mapping.UnMapCommand
...
import com.flop.idea.fim.fimscript.model.expressions.operators.AssignmentOperator.Companion.getByValue
...
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.CallCommandContext
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.DelfunctionCommandContext
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.EchoCommandContext
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.ExprContext
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.OtherCommandContext
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.RangeContext
import com.flop.idea.fim.fimscript.parser.generated.FimscriptParser.RangeOffsetContext
import java.util.stream.Collectors
import kotlin.reflect.KClass
import kotlin.reflect.full.primaryConstructor

object CommandVisitor : FimscriptBaseVisitor<Command>() {
  ...
  private fun parseRangeExpression(ctx: FimscriptParser.RangeExpressionContext?): Pair<String, Int> {
  ...
  private fun parseRangesUnit(ctx: FimscriptParser.RangeUnitContext): Array<Range> {
  ...
  override fun visitLet1Command(ctx: FimscriptParser.Let1CommandContext): Command {
  ...
  override fun visitLet2Command(ctx: FimscriptParser.Let2CommandContext): Command {
  ...
  override fun visitGoToLineCommand(ctx: FimscriptParser.GoToLineCommandContext): Command {
    val ranges: Ranges
    if (ctx.range() != null) {
  ...
  override fun visitCommandWithComment(ctx: FimscriptParser.CommandWithCommentContext): Command {
  ...
  override fun visitCommandWithoutComments(ctx: FimscriptParser.CommandWithoutCommentsContext): Command {
    val ranges = parseRanges(ctx.range())
    val commandName = ctx.name.text
    val argument = ctx.commandArgumentWithoutBars()?.text ?: ""
    return createCommandByCommandContext(ranges, argument, commandName)
  ...
  override fun visitCommandWithBars(ctx: FimscriptParser.CommandWithBarsContext): Command {
    val ranges = parseRanges(ctx.range())
    val commandName = ctx.name.text
  ...
  override fun visitShiftLeftCommand(ctx: FimscriptParser.ShiftLeftCommandContext): ShiftLeftCommand {
    val ranges = parseRanges(ctx.range())
  ...
  override fun visitShiftRightCommand(ctx: FimscriptParser.ShiftRightCommandContext): ShiftRightCommand {
    val ranges = parseRanges(ctx.range())
    val argument = (ctx.commandArgument?.text ?: "").trim()
  ...
  override fun visitExecuteCommand(ctx: FimscriptParser.ExecuteCommandContext): ExecuteCommand {
    val ranges = parseRanges(ctx.range())
    val expressions = ctx.expr().stream()
      .map { tree: ExprContext ->
        expressionVisitor.visit(tree)
  ...
  override fun visitLetCommand(ctx: FimscriptParser.LetCommandContext): Command {
    return com.flop.idea.fim.fimscript.parser.FimscriptParser.parseLetCommand(ctx.text)
