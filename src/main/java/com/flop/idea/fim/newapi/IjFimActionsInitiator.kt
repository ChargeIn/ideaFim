...
class IjFimActionsInitiator(val bean: ActionBeanClass) : FimActionsInitiator {
  override fun getInstance(): EditorActionHandlerBase = bean.instance
}

val FimActionsInitiator.ij: ActionBeanClass
  get() = (this as IjFimActionsInitiator).bean
