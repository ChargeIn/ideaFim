 ...
 * drawn over the inlay, which is a poor experience for Fim users (e.g. hitting `x` in this location will delete the
...
fun Editor.amountOfInlaysBeforeVisualPosition(pos: VisualPosition): Int {
  val newOffset = com.flop.idea.fim.helper.EditorHelper.visualPositionToOffset(this, pos)
