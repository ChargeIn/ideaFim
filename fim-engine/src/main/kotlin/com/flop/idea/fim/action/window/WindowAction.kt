 ...
 */
package com.flop.idea.fim.action.window
 ...
 * @author vlan
 */
class WindowDownAction : FimActionHandler.SingleExecution() {
 ...
 * @author vlan
 */
class WindowLeftAction : FimActionHandler.SingleExecution() {
  override val type: Command.Type = Command.Type.OTHER_READONLY
 ...
 * @author vlan
 */
class WindowRightAction : FimActionHandler.SingleExecution() {
  override val type: Command.Type = Command.Type.OTHER_READONLY
 ...
 * @author vlan
 */
class WindowUpAction : FimActionHandler.SingleExecution() {
  override val type: Command.Type = Command.Type.OTHER_READONLY
