...
class VisualToggleBlockModeAction : FimActionHandler.SingleExecution() {
  ...
  override fun execute(
    ...
    return if (listOption.contains("cmd")) {
      injector.visualMotionGroup.enterSelectMode(editor, FimStateMachine.SubMode.VISUAL_BLOCK)
    } else injector.visualMotionGroup
      .toggleVisual(editor, cmd.count, cmd.rawCount, FimStateMachine.SubMode.VISUAL_BLOCK)
  }
}
