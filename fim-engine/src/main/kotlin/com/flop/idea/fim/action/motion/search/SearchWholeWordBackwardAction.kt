...
import com.flop.idea.fim.handler.toMotionOrNoMotion
...
class SearchWholeWordBackwardAction : MotionActionHandler.ForEachCaret() {
  ...
  override fun getOffset(
    ...
    return injector.searchGroup.searchWord(editor, caret, operatorArguments.count1, true, Direction.BACKWARDS)
      .toMotionOrNoMotion()
  }
