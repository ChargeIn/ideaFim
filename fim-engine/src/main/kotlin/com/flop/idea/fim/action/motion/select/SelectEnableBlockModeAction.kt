...
class SelectEnableBlockModeAction : FimActionHandler.SingleExecution() {
  ...
  override fun execute(
    ...
    return injector.visualMotionGroup.enterSelectMode(editor, FimStateMachine.SubMode.VISUAL_BLOCK)
  }
}
