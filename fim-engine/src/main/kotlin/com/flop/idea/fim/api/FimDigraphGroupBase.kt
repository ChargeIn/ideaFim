...
abstract class FimDigraphGroupBase() : FimDigraphGroup {
  ...
  override fun displayAsciiInfo(editor: FimEditor) {
  ...
  private fun loadDigraphs() {
    ...
    // TODO - load custom digraphs from .ideafimrc
  }

  override fun parseCommandLine(editor: FimEditor, args: String): Boolean {
    if (args.isEmpty()) {
      showDigraphs(editor)
      return true
    }
