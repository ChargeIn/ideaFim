...
import com.flop.idea.fim.helper.CharacterHelper.charType
import kotlin.math.abs
import kotlin.math.min

abstract class FimSearchHelperBase : FimSearchHelper {
  override fun findNextWord(editor: FimEditor, searchFrom: Int, count: Int, bigWord: Boolean): Long {
