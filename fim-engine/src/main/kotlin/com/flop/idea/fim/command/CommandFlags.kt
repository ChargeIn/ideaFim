...
/**
 * Fim defines three types of motions. These types mostly affect the behaviour of `d` command and friends.
 * The type of the motion can be found in fim documentation for this motion.
 */
