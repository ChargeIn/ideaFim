...
package com.flop.idea.fim.fimscript.model.expressions.operators.handlers.unary
...
object MinusOperatorHandler : UnaryOperatorHandler() {
  ...
  override fun performOperation(value: FimDataType): FimDataType {
    return if (value is FimFloat) {
      FimFloat(-value.asDouble())
    } else {
      FimInt(-value.asDouble().toInt())
    }
  }
}
