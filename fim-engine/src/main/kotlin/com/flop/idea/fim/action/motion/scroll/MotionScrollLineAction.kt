...
class MotionScrollLineDownAction : FimActionHandler.SingleExecution() {
  ...
  override fun execute(
    ...
    return injector.motion.scrollLine(editor, cmd.count)
  }
}

class MotionScrollLineUpAction : FimActionHandler.SingleExecution() {
  override val type: Command.Type = Command.Type.OTHER_READONLY
