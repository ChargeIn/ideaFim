 ...
 */
package com.flop.idea.fim.action.change.change.number
...
sealed class IncNumber(val inc: Int, private val avalanche: Boolean) : VisualOperatorActionHandler.ForEachCaret() {
  ...
  override fun executeAction(
    ...
    return injector.changeGroup.changeNumberVisualMode(editor, caret, range.toFimTextRange(false), inc * cmd.count, avalanche)
  }
}
