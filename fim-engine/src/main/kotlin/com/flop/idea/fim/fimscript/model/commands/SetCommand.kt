 ...
 *
 *
 * @param editor    The editor the command was entered for, null if no editor - reading .ideafimrc
...
fun parseOptionLine(editor: FimEditor, args: String, scope: OptionScope, failOnBad: Boolean): Boolean {
...
private fun showOptions(editor: FimEditor, nameAndToken: Collection<Pair<String, String>>, scope: OptionScope, showIntro: Boolean) {
  val optionService = injector.optionService
