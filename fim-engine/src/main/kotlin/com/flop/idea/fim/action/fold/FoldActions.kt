...
package com.flop.idea.fim.action.fold
...
class FimCollapseAllRegions : FimActionHandler.SingleExecution() {
...
class FimCollapseRegion : FimActionHandler.SingleExecution() {
...
class FimCollapseRegionRecursively : FimActionHandler.SingleExecution() {
  override val type: Command.Type = Command.Type.OTHER_READONLY
...
class FimExpandAllRegions : FimActionHandler.SingleExecution() {
...
class FimExpandRegion : FimActionHandler.SingleExecution() {
...
class FimExpandRegionRecursively : FimActionHandler.SingleExecution() {
