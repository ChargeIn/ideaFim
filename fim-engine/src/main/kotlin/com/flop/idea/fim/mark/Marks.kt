...
interface Mark {
  ...
  fun offset(editor: FimEditor): Int = editor.logicalPositionToOffset(FimLogicalPosition(logicalLine, col))
...
data class FimMark(
  ...
  companion object {
    @JvmStatic
    fun create(key: Char?, logicalLine: Int?, col: Int?, filename: String?, protocol: String?): FimMark? {
      return FimMark(
        key ?: return null,
