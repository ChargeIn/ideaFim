...
object KeywordOptionHelper {
  ...
  fun updateSpecs() {
    keywordSpecs = valuesToValidatedAndReversedSpecs(
      parseValues(
        (injector.optionService.getOptionValue(OptionScope.GLOBAL, OptionConstants.iskeywordName) as FimString).value
      )
    )!!.toMutableList()
  }
...
object KeywordOptionChangeListener : OptionChangeListener<FimDataType> {
