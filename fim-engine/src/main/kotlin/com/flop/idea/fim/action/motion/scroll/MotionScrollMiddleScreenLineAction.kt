...
class MotionScrollMiddleScreenLineAction : FimActionHandler.SingleExecution() {
...
class MotionScrollMiddleScreenLineStartAction : FimActionHandler.SingleExecution() {
  override val type: Command.Type = Command.Type.OTHER_READONLY
