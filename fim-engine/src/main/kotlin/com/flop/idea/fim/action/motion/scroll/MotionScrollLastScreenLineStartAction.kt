...
class MotionScrollLastScreenLineStartAction : FimActionHandler.SingleExecution() {
  ...
  override fun execute(editor: FimEditor, context: ExecutionContext, cmd: Command, operatorArguments: OperatorArguments): Boolean {
    return injector.motion.scrollLineToLastScreenLine(editor, cmd.rawCount, true)
  }
}
