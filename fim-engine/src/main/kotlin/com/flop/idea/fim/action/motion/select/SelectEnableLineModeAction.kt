...
class SelectEnableLineModeAction : FimActionHandler.SingleExecution() {
  ...
  override fun execute(
    ...
    editor.forEachNativeCaret { caret ->
      ...
      caret.fimSetSystemSelectionSilently(lineStart, lineEnd)
    }
    return injector.visualMotionGroup.enterSelectMode(editor, FimStateMachine.SubMode.VISUAL_LINE)
  }
}
