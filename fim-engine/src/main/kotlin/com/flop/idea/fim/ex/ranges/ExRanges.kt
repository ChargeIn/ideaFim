...
sealed class Range(
   ...
   */
  fun getLine(editor: FimEditor, lastZero: Boolean): Int {
    val line = getRangeLine(editor, lastZero)
    return line + offset
  }

  fun getLine(editor: FimEditor, caret: FimCaret, lastZero: Boolean): Int {
   ...
   */
  protected abstract fun getRangeLine(editor: FimEditor, lastZero: Boolean): Int

  protected abstract fun getRangeLine(editor: FimEditor, caret: FimCaret, lastZero: Boolean): Int
...
class LineNumberRange : Range {
   ...
   */
  override fun getRangeLine(editor: FimEditor, lastZero: Boolean): Int {
...
class MarkRange(private val mark: Char, offset: Int, move: Boolean) : Range(offset, move) {
  ...
  override fun getRangeLine(editor: FimEditor, caret: FimCaret, lastZero: Boolean): Int = getRangeLine(editor, lastZero)
...
class SearchRange(pattern: String, offset: Int, move: Boolean) : Range(offset, move) {
  ...
  private fun getSearchOffset(editor: FimEditor, line: Int, direction: Direction, lastZero: Boolean): Int {
  ...
  companion object {
    private val logger = fimLogger<SearchRange>()
  }
